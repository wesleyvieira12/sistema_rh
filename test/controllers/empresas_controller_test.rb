...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { agent: @empresa.agent, cnpj: @empresa.cnpj, name: @empresa.name } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { agent: @empresa.agent, cnpj: @empresa.cnpj, name: @empresa.name } }
